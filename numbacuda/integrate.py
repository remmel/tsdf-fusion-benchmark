...
class TSDFVolumeNumbaCuda(TSDFVolumeBase):
    using = "Using numba cuda (@cuda.jit)"
    useGPU = True #Handle only with GPU
    ...
    def integrate(self, color_im, depth_im, cam_intr, cam_pose, obs_weight):
        ...
        self.integrate_kernel[blocks_per_grid, threads_per_block](color_im, depth_im, cam_intr, cam_pose_inv, obs_weight,
